context('test as_timeseries_.zoo')

library(zoo)
library(astimeseries)

rets <- zoo(matrix(rnorm(9), ncol = 3), order.by = as.Date(c('2019-01-01', '2019-01-02', '2019-01-03')))
...
test_that("coercion from zoo to timeSeries works", {
